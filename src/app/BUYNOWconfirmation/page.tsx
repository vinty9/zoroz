  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      if (orderId) {
        ...
        // Notify cart page of completed checkout
        router.push(`/orderstatus?orderId=${orderId}&cart=${encodeURIComponent(JSON.stringify(orderData.cart))}`);
...
export default function WrappedBUYNOWconfirmationPage() {
  return (
